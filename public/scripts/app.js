...
var DecisionApp = function (_React$Component) {
   ...
   function DecisionApp() {
      ...
      return _possibleConstructorReturn(this, (DecisionApp.__proto__ || Object.getPrototypeOf(DecisionApp)).apply(this, arguments));
   }

   _createClass(DecisionApp, [{
      key: "render",
      value: function render() {
         var title = "Decisions, Decisions";
         var subtitle = "Take the guesswork out of making life decisions!";
         var options = ["Tory Lanez", "Drake", "Jazz Cartier"];
         ...
         return React.createElement(
            ...
            React.createElement(Options, { optList: options }),
   ...
   _createClass(Options, [{
      ...
      value: function render() {
         ...
         return React.createElement(
            ...
            this.props.optList.map(function (option) {
